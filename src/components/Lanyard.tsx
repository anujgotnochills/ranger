...
// Next.js: Assets should be placed in the public folder and referenced by absolute path
...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-screen flex justify-center items-center transform scale-100 origin-center pointer-events-none">
      <Canvas
        camera={{ position, fov }}
          ...
          >
            ...
            <Html transform distanceFactor={0.9} position={[0, 0, 0.02]} zIndexRange={[100, 0]} pointerEvents="none">
              <div className="card-badge">
                ...
                <div className="card-brand">RANGER</div>
                <div className="card-line" />
                <div className="card-subtitle">FUTURE SYSTEMS</div>
              </div>
            </Html>
